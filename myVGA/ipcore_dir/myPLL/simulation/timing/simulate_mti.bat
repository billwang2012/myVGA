...
vlog -work work myPLL_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax myPLL_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.myPLL_tb work.glbl
