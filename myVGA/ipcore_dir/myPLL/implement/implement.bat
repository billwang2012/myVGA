...
xst -ifn xst.scr
move myPLL_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\myPLL_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc myPLL_exdes.ucf myPLL_exdes

echo 'Running map'
map -timing -pr b myPLL_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm myPLL_exdes -w routed.ncd routed.v
cd ..
